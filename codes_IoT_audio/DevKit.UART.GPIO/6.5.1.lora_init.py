...
# --- LoRa Pins and SPI Bus Setup --- GPIO-C6
lora_pins = {
    'dio_0': 3,        # DIO0 pin for interrupt
    'ss': 1,           # Slave Select (SS)
    'reset': 14,       # Reset pin
    'sck': 4,          # SPI Clock pin
    'miso': 7,         # SPI MISO pin
    'mosi': 6          # SPI MOSI pin
...
lora_default = {
    'frequency': 8685E5,             # Frequency for Europe (868 MHz ISM band)
    'tx_power_level': 14,           # Transmission power level (14 dBm)
    'signal_bandwidth': 500E3,      # Signal bandwidth (125 kHz)
    ...
    'sync_word': 0x18,              # LoRa sync word -0x12 special: 0x18
